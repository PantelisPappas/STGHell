...
<?php
$all = "select * from scoreboard where etairia='Cave' order by score desc";
...
if ($_POST['GGame'] !== 'All'){
  $all = "select * from scoreboard where (etairia='Cave' and game = '$GGame' ) order by score desc";
  $result_all = $link->query($all);
}
if ($_POST['Ddiff'] !== 'All'){
  $all = "select * from scoreboard where (etairia='Cave' and diff = '$Ddiff' ) order by score desc";
  $result_all = $link->query($all);
}
if ($_POST['Rrun'] !== 'All'){
  $all = "select * from scoreboard where (etairia='Cave' and run = '$Rrun' ) order by score desc";
  $result_all = $link->query($all);
}
if ($_POST['GGame'] !== 'All' && $_POST['Ddiff'] !== 'All') {
  $all = "select * from scoreboard where (etairia='Cave' and game = '$GGame' and diff = '$Ddiff') order by score desc";
  $result_all = $link->query($all);
}
if ($_POST['GGame'] !== 'All' && $_POST['Rrun'] !== 'All') {
  $all = "select * from scoreboard where (etairia='Cave' and game = '$GGame' and diff = '$Rrun') order by score desc";
  $result_all = $link->query($all);
}
if ($_POST['Rrun'] !== 'All' && $_POST['Ddiff'] !== 'All') {
  $all = "select * from scoreboard where (etairia='Cave' and game = '$Rrun' and diff = '$Ddiff') order by score desc";
  $result_all = $link->query($all);
}
if ($_POST['GGame'] !== 'All' && $_POST['Ddiff'] !== 'All' && $_POST['Rrun'] !== 'All') {
  $all = "select * from scoreboard where (etairia='Cave' and game = '$GGame' and diff = '$Ddiff' and run = '$Rrun') order by score desc";
  $result_all = $link->query($all);
}
