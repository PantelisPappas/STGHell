...
<?php
$all = "select * from scoreboard where etairia='Touhou' order by score desc";
...
if ($_POST['GGame'] !== 'All'){
  $all = "select * from scoreboard where (etairia='Touhou' and game = '$GGame' ) order by score desc";
  $result_all = $link->query($all);
}
if ($_POST['Ddiff'] !== 'All'){
  $all = "select * from scoreboard where (etairia='Touhou' and diff = '$Ddiff' ) order by score desc";
  $result_all = $link->query($all);
}
if ($_POST['Rrun'] !== 'All'){
  $all = "select * from scoreboard where (etairia='Touhou' and run = '$Rrun' ) order by score desc";
  $result_all = $link->query($all);
}
if ($_POST['GGame'] !== 'All' && $_POST['Ddiff'] !== 'All') {
  $all = "select * from scoreboard where (etairia='Touhou' and game = '$GGame' and diff = '$Ddiff') order by score desc";
  $result_all = $link->query($all);
}
if ($_POST['GGame'] !== 'All' && $_POST['Rrun'] !== 'All') {
  $all = "select * from scoreboard where (etairia='Touhou' and game = '$GGame' and diff = '$Rrun') order by score desc";
  $result_all = $link->query($all);
}
if ($_POST['Rrun'] !== 'All' && $_POST['Ddiff'] !== 'All') {
  $all = "select * from scoreboard where (etairia='Touhou' and game = '$Rrun' and diff = '$Ddiff') order by score desc";
  $result_all = $link->query($all);
}
if ($_POST['GGame'] !== 'All' && $_POST['Ddiff'] !== 'All' && $_POST['Rrun'] !== 'All') {
  $all = "select * from scoreboard where (etairia='Touhou' and game = '$GGame' and diff = '$Ddiff' and run = '$Rrun') order by score desc";
  $result_all = $link->query($all);
}
